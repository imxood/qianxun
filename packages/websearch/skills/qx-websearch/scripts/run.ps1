# qx-websearch skill launcher (Windows, PowerShell 5.1 compatible).
#
...
# qx-websearch"); this script picks a working way to run it here.
#
...
#   1. A compatible qx-websearch already on PATH  -> run it directly.
