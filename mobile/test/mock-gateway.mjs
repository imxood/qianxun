...
const server = http.createServer(async (req, res) => {
  ...
  if (pathname === '/pair-qr') {
    ...
    res.end(`<!doctype html><html><body style="margin:0;background:#fff;display:grid;place-items:center;height:100vh"><img src="/pair-qr.png" style="width:min(90vmin,720px)"></body></html>`)
    return
  }
  ...
  if (pathname === '/qx-mobile/info') {
    ...
    res.end(JSON.stringify({ app: 'qianxun', version: '0.1.0-test', hostname: 'QX-TEST-PC', dshReady: true }))
    return
  }
  ...
  if (pathname === '/qx-mobile/custom.css' || pathname === '/qx-mobile/custom.js') {
