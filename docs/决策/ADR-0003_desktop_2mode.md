...
- `docs/事实源/runtime-state.md`: qianxun-runtime 子系统状态
- `docs/事实源/desktop-state.md`: qianxun-desktop 子系统状态
- `docs/经验/2026-06-08_phase_4a-1_runbook.md`: 4a-1 跑通指南
- `docs/子项目规划/04b-tauri-runtime-integration.md`: tauri + runtime 集成规划
- `docs/子项目规划/04c-qianxun-runtime-extraction.md`: qianxun-runtime 抽取设计
