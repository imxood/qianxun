...
规划文档 `docs/子项目规划/04b-tauri-runtime-integration.md` sub-task #2 写的是 "应该怎么做",
...
- `docs/子项目规划/04b-tauri-runtime-integration.md` (上位规划, sub-task #1-7 排序)
- `docs/子项目规划/04c-qianxun-runtime-extraction.md` (sub-task #1 设计, 已完成)
...
- 上次经验 `docs/经验/2026-06-08_qianxun-runtime-extraction.md`