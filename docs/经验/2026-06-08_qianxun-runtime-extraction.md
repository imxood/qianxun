...
`docs/子项目规划/04b-tauri-runtime-integration.md`), 桌面端要复用这 5 个核心,
...
规划文档 `docs/子项目规划/04c-qianxun-runtime-extraction.md` (654 行) 写的是
...
3. **规划文档 + 详细设计文档 + 项目日记 3 文档配套**:
   ...
   - 本文件 (`经验/2026-06-08_...`) — 写"实际踩了什么", 在 commit 后写
