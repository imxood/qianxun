...
> **状态: 历史归档** — 本文档记录的是 2026-06-08 Phase ABCD 4 阶段收尾, 不是当前活跃工作项。当前活跃工作项见 [设计/TODO/2026-06-11_v2_缺口补齐_14项/](../设计/TODO/2026-06-11_v2_缺口补齐_14项/) (14 缺口 P0+P1 实施)。
>
...
| 文档 | 行数 |
|---|---|
| `docs/经验/2026-06-08_Phase_A_5_binary_切_runtime.md` | ~250 |
| `docs/经验/2026-06-08_Phase_C_memory_真实化.md` | ~250 |
| `docs/经验/2026-06-08_Phase_B_vps_server_最小收尾.md` | ~250 |
| `docs/经验/2026-06-08_Phase_D_plan_真实执行.md` | ~280 |
...
按 docs/设计/TODO/2026-06-01_TUI性能与Agent开发工具优化/阶段路线.md 的 A-G:
...
- `docs/子项目规划/04b-tauri-runtime-integration.md` (前置: Svelte 切 invoke)
- `docs/子项目规划/04c-qianxun-runtime-extraction.md` (前置: RuntimeState 抽离)
- `docs/设计/TODO/2026-06-01_TUI性能与Agent开发工具优化/阶段路线.md` (背景: A-G 路线)
- `docs/经验/2026-06-08_Phase_A_5_binary_切_runtime.md`
- `docs/经验/2026-06-08_Phase_C_memory_真实化.md`
- `docs/经验/2026-06-08_Phase_B_vps_server_最小收尾.md`
- `docs/经验/2026-06-08_Phase_D_plan_真实执行.md`
