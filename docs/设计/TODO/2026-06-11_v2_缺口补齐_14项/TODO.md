...
- 同步更新 [事实源/runtime-state.md](../../事实源/runtime-state.md) 公开 API 表
- 同步更新 [事实源/desktop-state.md](../../事实源/desktop-state.md) Tauri command 表
...
**详细**: [设计/06_压缩前MemoryFlush.md](../../能力层/06_压缩前MemoryFlush.md)
**行数**: ~160
...
### [ ] 缺口 13 — 双层循环 + 20 EventStream (重构, 后置)

**借鉴**: [openclaw-mini](E:\git\ai\openclaw-mini) outer/inner loop
**详细**: [能力层/13_双层循环与EventStream.md](../../能力层/13_双层循环与EventStream.md)
**行数**: ~365
**依赖**: v2 E2 完成
**步骤**:
...
### [ ] 缺口 08 — Hashline Edit 防 Stale

**借鉴**: [oh-my-opencode](E:\git\ai\oh-my-opencode) `hashline-edit`
**详细**: [能力层/08_HashlineEdit防Stale.md](../../能力层/08_HashlineEdit防Stale.md)
**行数**: ~270
**依赖**: 无
**步骤**:
...
**详细**: [设计/11_Verdict四态与BDD验收.md](../../能力层/11_Verdict四态与BDD验收.md)
**行数**: ~345
...
### [ ] 缺口 09 — Context Window 五层优先

**借鉴**: [moltis](E:\git\ai\moltis) 5 层 precedence
**详细**: [能力层/09_ContextWindow五层优先.md](../../能力层/09_ContextWindow五层优先.md)
**行数**: ~305
**依赖**: 无
**步骤**:
...
### [ ] 缺口 14 — Knowledge 五状态 + Gate (跟 Memory Flush 联动)

**借鉴**: [mempal](E:\git\ai\mempal) 5 状态 + Gate
**详细**: [能力层/14_Knowledge五状态与Gate.md](../../能力层/14_Knowledge五状态与Gate.md)
**行数**: ~420
...
**详细**: [能力层/10_SessionQueue五种模式.md](../../能力层/10_SessionQueue五种模式.md)
**行数**: ~415
**依赖**: v2 E2 完成
**步骤**:
...
- [ ] [事实源/runtime-state.md](../../事实源/runtime-state.md) 公开 API 表更新
- [ ] [事实源/desktop-state.md](../../事实源/desktop-state.md) Tauri command 表更新
- [ ] [agent_loop_v2.md](../../设计/agent_loop_v2.md) §7 实施阶段加 14 缺口
...
| 10 Queue 5 mode | ⏳ |  |  |  |  |
| 11 Verdict + BDD | ⏳ |  |  |  |  |
| 12 Provider Failover | ⏳ |  |  |  | 投资大 |
| 13 双层循环 | ⏳ |  |  |  | 重构 |
| 14 Knowledge Gate | ⏳ |  |  |  | 跟 06 联动 |
