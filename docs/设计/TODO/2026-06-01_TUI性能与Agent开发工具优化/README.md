...
- `docs/事实源/runtime-state.md` (Runtime 子系统状态)
- `docs/事实源/memory-state.md` (Memory 子系统状态)
- `docs/事实源/skills-state.md` (Skills 子系统状态)
- `docs/决策/ADR-0003_desktop_2mode.md` (现行架构决策)
- `docs/子项目规划/_shared-contract.md` (RuntimeApi 契约)
