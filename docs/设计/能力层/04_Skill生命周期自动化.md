...
> 状态: 已实现 (v0.2, 9 单测 passed) | 适用范围: qianxun-core / qianxun-runtime | 最后更新: 2026-06-11 | 版本: v0.2
> **优先级**: P0 但**可独立后置**, 跟其他 P0 (02/01/03/05) 解耦, 任意时刻启动不阻塞主线。详见 [00_总览.md §3](../00_总览.md)。
