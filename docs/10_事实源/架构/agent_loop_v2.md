...
> 状态: 生效 (待 code review) | 适用范围: qianxun-core / qianxun-runtime | 最后更新: 2026-06-10
...
**v2+1 增量补齐**: 14 个生产级能力缺口, 见 [设计/00_总览.md](../../设计/00_总览.md) (P0 5 个: Hook 退出码 / LLM 错误分类 / SubAgent 白名单 / Skill 自学习 / 后台异步任务; P1 9 个)。本文件**只承载基础设施**, 14 缺口独立成文。
...
- `docs/10_事实源/runtime-state.md` — 现有 RuntimeApi 12 方法 (v2 加 5 个 = 17)
- `docs/10_事实源/desktop-state.md` — 现有 Tauri command 表 (v2 加 5 个 = 18)
- `docs/30_决策/ADR-0003_desktop_2mode.md` — Tauri + ACP 2-Mode (v2 延伸为 3-Mode)
- `docs/30_子项目规划/_shared-contract.md` — 跨 Track 契约 (v2 加 5 段)
