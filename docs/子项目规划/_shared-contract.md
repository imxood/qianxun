...
>
> **事实源**: [runtime-state.md](../事实源/runtime-state.md) + [desktop-state.md](../事实源/desktop-state.md)
...
- 设计基线: `docs/决策/ADR-0003_desktop_2mode.md`
- 事实源: `docs/事实源/runtime-state.md` + `desktop-state.md`
- 集成规划: `docs/子项目规划/04b-tauri-runtime-integration.md`
- 抽取设计: `docs/子项目规划/04c-qianxun-runtime-extraction.md`
- 实施经验: `docs/经验/2026-06-08_04b_subtask_{2,3,4}_*.md`
