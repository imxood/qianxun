...
>
> **设计基线**: [ADR-0003: 桌面 + ACP 同进程 2-Mode 互斥](../决策/ADR-0003_desktop_2mode.md)
>
...
详见 [`desktop-state.md`](../事实源/desktop-state.md) "端到端链路" 段。简要 11 步:
...
| 文档 | 位置 | 内容 |
|---|---|---|
| **本文件** | `docs/子项目规划/00-RUNNING-GUIDE.md` | tauri 桌面跑通指南 |
| 项目规则 | `CLAUDE.md` | 技术栈 + LLM Provider 配置 + 模块结构 |
| 当前决策 | `docs/决策/ADR-0003_desktop_2mode.md` | tauri+ACP 2-Mode 互斥 (唯一现行决策) |
| 共享契约 | `docs/子项目规划/_shared-contract.md` | RuntimeApi + SseEvent 契约 (v3) |
| Tauri + Runtime 集成 | `docs/子项目规划/04b-tauri-runtime-integration.md` | 当前 active 规划 |
| qianxun-runtime 抽取 | `docs/子项目规划/04c-qianxun-runtime-extraction.md` | runtime crate 抽取设计 |
| qianxun-runtime 状态 | `docs/事实源/runtime-state.md` | RuntimeApi 6 方法 + SseEvent 12 变体 |
| qianxun-desktop 状态 | `docs/事实源/desktop-state.md` | Tauri 10 command + 11 store + 端到端链路 |
| Tauri README | `qianxun-desktop/README.md` | Tauri 端命令 + P0 缺口 |
| 实施经验 | `docs/经验/2026-06-08_04b_subtask_{2,3,4}_*.md` | Tauri 集成实施记录 |
